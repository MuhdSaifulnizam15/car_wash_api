...
router.post('/', auth('manageSale'), validate(saleValidation.createSales), saleController.createSale);
...
router.post('/update/:saleId', auth('manageSale'), validate(saleValidation.updateSales), saleController.updateSale);
router.post('/delete/:saleId', auth('manageSale'), validate(saleValidation.deleteSales), saleController.deleteSale);
